...
params:
  ...
  trinity: "/usr/share/trinity291/Trinity"
...
system("gunzip _ncbi_downloads/genomes/Manihot_esculenta_genomic_refseq.fna.gz")
...
for (i in f){
    system(paste0(params$fastqc, " ", i, " -o data/", params$SRA,
                  "/ -t 6"))
}
```
